...
vid_cam = cv2.VideoCapture(1)  #Start video capturing

face_cascade = cv2.CascadeClassifier('/Users/shameerali/Desktop/face detection/haar/haarcascade_frontalface_default.xml') # Detect object in video stream using Haarcascade Frontal Face
...
while(True):
    ...
    elif count>2000:                                     # If image taken reach 100, stop taking video
        break
