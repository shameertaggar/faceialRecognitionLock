...
detector = cv2.CascadeClassifier("/Users/shameerali/Desktop/face detection/haar/haarcascade_frontalface_default.xml")
...
faces,ids = getImagesAndLabels('/Users/shameerali/PycharmProjects/faceialRecognitionLock/dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists('/Users/shameerali/Desktop/face detection/trainer')    # Save the model into trainer.yml
recognizer.save('/Users/shameerali/Desktop/face detection/trainer/trainer.yml')
